...
from Sangtei import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP, spamwtc
    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                update.effective_message.reply_text(
                    "Hey {}, Ka hming chu {} ani! I group {} a min dahluh avang in ka lawm e"
                    " Chuan  kan channel: @SangteiUpdates hi i lo join ngei dawn nia i hriatbelh zel nan!".format(
                ...
                context.bot.send_message(
                    MESSAGE_DUMP,
                    "Sangtei have been added to <pre>{}</pre> with ID: \n<pre>{}</pre>".format(
                        chat.title, chat.id
                    ),
                    parse_mode=ParseMode.HTML,
                )
                ...
                if welc_mutes == "strong":
                    ...
                    msg.reply_text(
                        "{}\nThil sawi i duh ve anih chuan a hnuaia button khu hmet rawh.".format(
                            new_join_mem
                        ),
...
def user_button(update, context):
    ...
    if join_user == user.id:
        query.answer(text="Aw! Mihring ngei i ni e, Unmute i ni!")
        context.bot.restrict_chat_member(
            chat.id,
            user.id,
            permissions=ChatPermissions(
        ...
        query.answer(text="I tih ve kha maw kan phal lo keuh a!")
