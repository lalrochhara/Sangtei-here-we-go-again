...
from Sangtei.modules.helper_funcs.chat_status import user_admin, is_user_admin
from Sangtei.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from Sangtei.modules.helper_funcs.filters import CustomFilters
from Sangtei.modules.helper_funcs.alternate import typing_action, send_action
from Sangtei.modules.sql.users_sql import get_all_chats
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal at @Sangteibot if you think it's invalid."
    else:
        text = text.format("No")
    return text
...
Sangtei will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group[.](https://telegra.ph/file/c1051d264a5b4146bd71e.jpg)
"""
