...
from Sangtei.modules.purge import client
...
PM_START_TEXT = f"""
Hey there! My name is <b>{dispatcher.bot.first_name}</b> [❤️](https://imgtr.ee/images/2023/08/04/99e538ba276e281257b8116038af9d3c.png). If you have any questions on how to use me, click the 'Help & Commands' button.
...
buttons = [
    [
        InlineKeyboardButton(
            text="Group ah hmang rawh", url="t.me/SangteiBot?startgroup=true"
        ),
        InlineKeyboardButton(text="Updates", url="="https://t.me/SangteiUpdates"),
    ]
]

buttons += [
    [InlineKeyboardButton(text="Tanpuina & Hrilhfiahna", callback_data="help_back")]
]


HELP_STRINGS = f"""
Hello there! My name is *{dispatcher.bot.first_name}* [❤️](https://imgtr.ee/images/2023/08/04/99e538ba276e281257b8116038af9d3c.png).
...
def help_button(update, context):
    ...
    try:
        if mod_match:
            ...
            text = (
                "Heng te hi he *{}* module tana hrilhfiahna te chu an ni:\n".format(
            ...
            query.message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text="kir leh", callback_data="help_back"
                            )
                        ]
                    ]
                ),
...
def get_help(update, context):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text(
            "Command hman theih ho i hriat duh chuan PM ah min rawnn be rawh.",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
...
def send_settings(chat_id, user_id, user=False):
    if user:
        if USER_SETTINGS:
            ...
            dispatcher.bot.send_message(
                user_id,
                "Hengte hi setting i siam tawh te an ni:" + "\n\n" + settings,
                parse_mode=ParseMode.MARKDOWN,
            )
